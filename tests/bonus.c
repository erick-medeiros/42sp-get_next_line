...
/*   Updated: 2022/04/28 05:42:29 by eandre-f         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	bonus(void)
{
	...
	fd1 = open("./tests/test1", O_RDWR);
	fd2 = open("./tests/test2", O_RDWR);
	fd3 = open("./tests/test3", O_RDWR);
	fd4 = open("./tests/test4", O_RDWR);
